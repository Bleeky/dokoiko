...
<div class="container contact" style="padding-top: 13px; padding-bottom: 13px;">
	...
	<p class="name">
		{{ Form::text('name', null, array('placeholder'=>'Nom', 'class'=>'feedback-input mailcolor contact-name', 'autocomplete'=>'off', 'id'=>'name')) }}
	</p>
	<p class="email">
		{{ Form::text('email', null, array('placeholder'=>'Email', 'class'=>'feedback-input mailcolor contact-email', 'autocomplete'=>'off', 'id'=>'email')) }}
	</p>
	<p class="text">
		{{ Form::textarea('message', null, array('placeholder'=>'Message', 'class'=>'feedback-input mailcolor contact-message', 'autocomplete'=>'off', 'id'=>'message')) }}
	</p>
	<div class="submit">
