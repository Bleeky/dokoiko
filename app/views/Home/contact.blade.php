...
<div class="container contact" style="padding-top: 50px;padding-bottom: 30px;">
	...
	<p class="name">
		{{ Form::text('name', null, array('placeholder'=>'Nom', 'class'=>'feedback-input', 'required'=>'required', 'autocomplete'=>'off', 'id'=>'name')) }}
	</p>
	<p class="email">
		{{ Form::text('email', null, array('placeholder'=>'Email', 'class'=>'feedback-input', 'required'=>'required', 'autocomplete'=>'off', 'id'=>'email')) }}
	</p>
	<p class="text">
		{{ Form::textarea('message', null, array('placeholder'=>'Message', 'class'=>'feedback-input', 'required'=>'required', 'autocomplete'=>'off', 'id'=>'message')) }}
	</p>
	<div class="submit">
